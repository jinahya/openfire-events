...
@XmlTransient
abstract class ComponentEventPayloadWithComponent implements ComponentEventPayload {

    // -------------------------------------------------------------------------
    static <T extends ComponentEventPayloadWithComponent> T of(final Supplier<T> supplier, final JID component) {
        if (supplier == null) {
