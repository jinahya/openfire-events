...
public class ComponentUnregistered extends ComponentEvent {

    // -------------------------------------------------------------------------
    public static ComponentUnregistered of(final JID component) {
        final ComponentUnregistered instance = new ComponentUnregistered();
