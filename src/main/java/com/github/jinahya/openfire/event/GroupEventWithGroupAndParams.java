 ...
 */
abstract class GroupEventWithGroupAndParams extends GroupEvent {

    // -----------------------------------------------------------------------------------------------------------------
    static <T extends GroupEventWithGroupAndParams> T of(final Supplier<T> supplier, final Group group,
                                                         final Map params) {
