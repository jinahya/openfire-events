...
@XmlTransient
abstract class FileTransferEventPayloadWithTransfer implements FileTransferEventPayload {

    // -----------------------------------------------------------------------------------------------------------------
    static <T extends FileTransferEventPayloadWithTransfer> T of(final Supplier<T> supplier,
