...
@XmlTransient
abstract class FileTransferEventPayloadWithTransferAndFlag extends FileTransferEventPayloadWithTransfer {

    // -----------------------------------------------------------------------------------------------------------------
    static <T extends FileTransferEventPayloadWithTransferAndFlag> T of(final Supplier<T> supplier,
