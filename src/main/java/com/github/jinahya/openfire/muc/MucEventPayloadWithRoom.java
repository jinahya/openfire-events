...
@XmlTransient
abstract class MucEventPayloadWithRoom implements MucEventPayload {

    // -----------------------------------------------------------------------------------------------------------------
    static <T extends MucEventPayloadWithRoom> T of(final Supplier<T> supplier, final JID room) {
        if (supplier == null) {
