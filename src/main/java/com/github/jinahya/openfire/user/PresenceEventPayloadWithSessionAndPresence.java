...
@XmlTransient
abstract class PresenceEventPayloadWithSessionAndPresence implements PresenceEventPayload {

    static <T extends PresenceEventPayloadWithSessionAndPresence> T of(final Supplier<T> supplier,
