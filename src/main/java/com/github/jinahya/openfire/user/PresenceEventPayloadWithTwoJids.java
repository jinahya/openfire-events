...
@XmlTransient
abstract class PresenceEventPayloadWithTwoJids implements PresenceEventPayload {

    static <T extends PresenceEventPayloadWithTwoJids> T of(final Supplier<T> supplier, final JID jid1,
                                                            final JID jid2) {
        if (supplier == null) {
